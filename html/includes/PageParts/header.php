...
<head>
  ...
  <base href="html">
  <link rel="stylesheet" href="<?php echo $baseLink;?>/bootstrap/css/bootstrap.min.css" type="text/css">
  <link rel="stylesheet" media="all" href="<?php echo $baseLink;?>/css/icons.css" type="text/css">
  <link rel="stylesheet" media="all" href="<?php echo $baseLink;?>/css/waves.css" type="text/css">
  <link rel="stylesheet" media="screen" href="<?php echo $baseLink;?>/masterslider/style/masterslider.css"  type="text/css">
  <link rel="stylesheet" media="all" href="<?php echo $baseLink;?>/css/normalise.css" type="text/css">
  <link rel="stylesheet" media="all" href="<?php echo $baseLink;?>/css/home_page_style.css" type="text/css" >
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
  <link rel="icon" href="favicon.ico" type="image/x-icon">
  <link rel="icon" href="<?php echo $baseLink;?>/img/icon.ico">
  <script src="<?php echo $baseLink;?>/js/modernizr.custom.js"></script>
  <script src="<?php echo $baseLink;?>/js/detectizr.min.js"></script>
</head>
<body>
